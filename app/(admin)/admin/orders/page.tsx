  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <select
                ...
                className="pl-4 pr-8 py-2 border border-stone-200 rounded-lg focus:border-black outline-none bg-white shadow-sm transition text-sm cursor-pointer w-full sm:w-auto"
            >
            ...
            <div className="relative w-full sm:w-64">
                ...
                <input 
                    ...
                    className="pl-10 pr-4 py-2 border border-stone-200 rounded-lg focus:border-black outline-none w-full bg-white shadow-sm transition"
                    value={searchTerm}
      ...
      <div className="bg-white border border-stone-200 rounded-xl shadow-sm overflow-hidden">
        ...
        {/* Pagination Controls */}
        {totalPages > 1 && (
            <div className="px-4 sm:px-6 py-4 border-t border-stone-200 flex justify-between items-center bg-stone-50">
                <button 
                    onClick={() => setCurrentPage(p => Math.max(1, p - 1))}
                    disabled={currentPage === 1}
                    className="px-3 sm:px-4 py-2 border border-stone-300 rounded-lg text-[10px] sm:text-xs font-bold uppercase disabled:opacity-50 hover:bg-white transition flex items-center gap-1"
                >
